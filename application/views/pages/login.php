...
<meta name="theme-color" content="#563d7c">
  ...
  <label for="inputEmail" class="sr-only">seuemail@unimar.com.br</label>
  ...
  <input type="password" name="password" id="inputPassword" class="form-control" placeholder="Senha" required>
	...
	<p>
    <!-- se não tiver um login, levar para a parte de cadastro -->
		<a href="<?= base_url()?>signup">Você ainda não possui uma conta?</a>
	</p>
